...
import type { RCFilterParams } from "@/types/rc";

interface RCFiltersProps {
  filters: RCFilterParams;
  onFiltersChange: (filters: RCFilterParams) => void;
}
...
export function RCFilters({ filters, onFiltersChange }: RCFiltersProps) {
  ...
  const handleStatusChange = (status: RCFilterParams["status"]) => {
