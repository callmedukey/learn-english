...
import { checkLevelLockPermission, getUserLevelLock } from '@/server-queries/level-locks';
...
describe('Level Lock System', () => {
  ...
  describe('getUserLevelLock', () => {
    ...
    it('should return the lock when it exists', async () => {
      ...
      (prisma.userLevelLock.findUnique as jest.Mock).mockResolvedValue(mockLock);
