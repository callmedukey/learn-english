...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\jmmfs\\OneDrive\\Área de Trabalho\\Projects\\learn-english\\prisma\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\jmmfs\\OneDrive\\Área de Trabalho\\Projects\\learn-english\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://learn-english_owner:npg_X5PCLDjAqo3B@ep-sweet-cake-a40vp929-pooler.us-east-1.aws.neon.tech/learn-english?sslmode=require"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nenum Role {\n  USER\n  ADMIN\n}\n\nenum Gender {\n  MALE\n  FEMALE\n  OTHER\n}\n\nmodel User {\n  id                  String    @id @default(cuid())\n  nickname            String    @unique\n  email               String    @unique\n  gender              Gender\n  country             String\n  birthday            DateTime\n  password            String? // Make password optional for social login\n  referrer            String? // Optional referrer nickname\n  emailVerified       DateTime?\n  image               String?\n  role                Role      @default(USER)\n  isProfileIncomplete Boolean   @default(true)\n  accounts            Account[]\n  sessions            Session[]\n  createdAt           DateTime  @default(now())\n  updatedAt           DateTime  @updatedAt\n\n  @@index([referrer])\n}\n\nmodel Account {\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n  createdAt         DateTime @default(now())\n  updatedAt         DateTime @updatedAt\n  user              User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([provider, providerAccountId])\n}\n\nmodel Session {\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n  createdAt    DateTime @default(now())\n  updatedAt    DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@id([identifier, token])\n}\n",
  "inlineSchemaHash": "943986f1325439bb3e097a6de1830a5201a3f57ddd3e4f095848b106eb3fe379",
  "copyEngine": true
}
