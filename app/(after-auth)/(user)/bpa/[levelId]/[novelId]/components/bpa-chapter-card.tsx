...
const BPAChapterCard: React.FC<BPAChapterCardProps> = ({
  ...
  const hasPremiumAccess = chapter.isFree || userHasPaidSubscription || isSuperUser || hasCampusAccess;
  ...
  return canAccessQuiz ? (
    <Link
      href={`/bpa/${levelId}/${novelId}/${chapter.id}`}
