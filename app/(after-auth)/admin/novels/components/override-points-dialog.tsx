...
import { overrideAllNovelQuestionPointsAction } from "../actions/override-points.actions";
...
const OverridePointsDialog: React.FC<OverridePointsDialogProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await overrideAllNovelQuestionPointsAction({
        arId,
        points: pointsValue,
      });
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <span className="font-semibold">{arLevel}</span>. This will override
            the current point values for every question in this level.
          </DialogDescription>
        </DialogHeader>
