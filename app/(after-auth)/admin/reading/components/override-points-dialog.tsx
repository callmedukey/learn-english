...
import { overrideAllQuestionPointsAction } from "../actions/override-points.actions";
...
const OverridePointsDialog: React.FC<OverridePointsDialogProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await overrideAllQuestionPointsAction({
        rcLevelId,
        points: pointsValue,
      });
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <span className="font-semibold">{rcLevel}</span>. This will override
